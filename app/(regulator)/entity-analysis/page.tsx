...
const NetworkGraph = dynamic(
  () => import('@/components/charts/NetworkGraph').then((mod) => mod.NetworkGraph),
  { ssr: false }
);
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-teal-100 text-teal-700 px-2.5 py-0.5 text-[10px] font-semibold">
      ...
      <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
        <div className="p-5 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-900">Network Intelligence</h2>
          </div>
          <p className="text-xs text-gray-500 mt-1">Interactive relationship map — click any entity to explore connections</p>
        </div>
        <div className="p-0">

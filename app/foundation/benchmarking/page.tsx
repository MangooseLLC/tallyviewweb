        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="relative flex-1 max-w-md">
            <select
              ...
              className="w-full appearance-none rounded-md border border-gray-200 bg-white px-3 py-2 pr-8 text-sm text-gray-700 focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-400"
            >
              {nonprofits

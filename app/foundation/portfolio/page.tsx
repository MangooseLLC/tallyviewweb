      ...
      <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-md border border-gray-200 py-2 pl-10 pr-4 text-sm text-gray-700 placeholder:text-gray-400 focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-400"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="rounded-md border border-gray-200 px-2 py-0.5 text-[11px] text-gray-600 focus:border-amber-400 focus:outline-none"
          >
                ...
                >
                  <td className="px-4 py-3">
                    <Link
                      ...
                      className="flex items-center gap-2 group-hover:text-amber-700 transition-colors"
                    >
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-medium text-gray-900 group-hover:text-amber-700 truncate max-w-[220px]">
                          {org.name}
                        </p>

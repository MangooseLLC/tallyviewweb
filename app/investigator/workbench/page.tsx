          ...
          <div className="rounded-lg border bg-white shadow-sm">
            ...
            <div className="p-4">
              <textarea
                ...
                className="w-full h-40 text-sm text-gray-700 border border-gray-200 rounded-lg p-3 resize-none focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-gray-50 placeholder:text-gray-400"
        ...
        <div className="col-span-8 space-y-5">
                ...
                <div key={i} className="rounded-lg border bg-white shadow-sm p-5">
                  <div className="animate-pulse space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-amber-600">{step}</span>
                    </div>
                    <div className="space-y-2">
          ...
          {analysisState === 'complete' && (
            <div className="space-y-5">
              {/* Risk Score Banner */}
              <div className="rounded-lg border bg-gradient-to-r from-amber-600 to-amber-600 p-5 shadow-sm text-white">
                <div className="flex items-center justify-between">
              ...
              <div className="rounded-lg border bg-white shadow-sm">
                <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] bg-amber-50 text-amber-600 font-medium px-1.5 py-0.5 rounded">
                      Auto-resolved
                    </span>
                  </div>
              ...
              <div className="rounded-lg border bg-white shadow-sm">
                <div className="p-4 border-b border-gray-100 flex items-center gap-2">
                  ...
                  <span className="text-[10px] bg-amber-50 text-amber-600 font-medium px-1.5 py-0.5 rounded ml-1">
                    AI Generated
                  </span>
                </div>
                <div className="p-4 space-y-4">

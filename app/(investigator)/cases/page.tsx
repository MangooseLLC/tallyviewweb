            ...
            <div key={item.stage} className="flex items-center flex-1">
              <button
                ...
                className={cn(
                  ...
                  stageFilter === item.stage && 'ring-2 ring-teal-500 shadow-sm'
                )}
              >
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-xs border border-gray-200 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 text-gray-700"
          >
              ...
              <Fragment key={c.id}>
                <tr
                  className={cn(
                    ...
                    expandedCase === c.id && 'bg-teal-50/30'
                  )}
                  onClick={() =>

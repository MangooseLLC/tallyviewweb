      ...
      <div className="space-y-3">
        <div className="relative max-w-lg">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white"
          />
        </div>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isExpanded && 'ring-1 ring-teal-200 shadow-md'
              )}
            >
              ...
              >
                ...
                <div className="flex items-center gap-4 flex-shrink-0">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm font-bold text-teal-600">{ft.frequencyInData}</p>
                  </div>
                  <div className="text-center">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs font-bold text-teal-600 w-12 text-right">
